...
namespace EMS.Views.Mails.Parts
{
    /// <summary>
    ...
    public sealed partial class MailSettingsPage : Page
    {
        ...
        public MailSettingsPage()
        {
            ...
            this.Loaded += new RoutedEventHandler(MailMainPage_Loaded);
        ...
        private void MailMainPage_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void ErrorDialog_Closed(ContentDialog sender, ContentDialogClosedEventArgs args)
        {
            ...
            if (sender.Title.Equals("Mail error"))
            {
                errorDialog.Closed -= ErrorDialog_Closed;
                errorDialog = null;
                Frame.Navigate(typeof(MailSettingsPage));
            }
        }
