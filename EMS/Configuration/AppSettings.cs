...
namespace EMS.Configuration
{
    ...
    {
        const string DB_NAME = "EMS";
        const string DB_VERSION = "1.00";
        //const string DB_BASEURL = "ms-appx:///";
        const string DB_BASEURL = "https://kelvince.com/db";
        ...
        {
            get => GetSettingsValue("SQLServerConnectionString", @"Data Source=KELVINCEPHILLIP;Initial Catalog=EMS;Integrated Security=SSPI");
