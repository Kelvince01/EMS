...
namespace EMS.ViewModels.ViewModels.Settings
{
    public class CreateDatabaseViewModel : ViewModelBase
    {
        ...
        private async Task CopyDataTables(SQLServerDb db)
        {
            using (var sourceDb = new SQLiteDb(SettingsService.PatternConnectionString))
            {
                ...
                ProgressStatus = "Creating table Employees...";
                foreach (var item in sourceDb.Employees.AsNoTracking())
                {
                ...
                ProgressStatus = "Creating table Projects...";
                foreach (var item in sourceDb.Projects.AsNoTracking())
                {
