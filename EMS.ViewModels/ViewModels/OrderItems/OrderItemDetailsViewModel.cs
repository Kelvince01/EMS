...
namespace EMS.ViewModels.ViewModels.OrderItems
{
    ...
    public class OrderItemDetailsViewModel : GenericDetailsViewModel<OrderItemModel>
    {
        ...
        public ICommand ProjectSelectedCommand => new RelayCommand<ProjectModel>(ProjectSelected);
        ...
        {
            yield return new RequiredConstraint<OrderItemModel>("Project", m => m.ProjectID);
